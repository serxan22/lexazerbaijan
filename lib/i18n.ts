...
export const dictionaries = {
  en: {
    ...
    pages: {
      ...
      glossaryBody: "Search key legal terms and learn their meaning through concise professional explanations.",
      glossarySearchPlaceholder: "Search legal terms...",
      glossaryNoResults: "No legal terms found.",
  ...
  az: {
    ...
    pages: {
      ...
      glossaryTitle: "Hüquqi terminlər",
      glossaryBody: "Əsas hüquqi terminləri axtarın və onların mənasını qısa, peşəkar izahlarla öyrənin.",
      glossarySearchPlaceholder: "Hüquqi terminlərdə axtar...",
      glossaryNoResults: "Uyğun hüquqi termin tapılmadı.",
  ...
  ru: {
    ...
    pages: {
      ...
      glossaryTitle: "Юридический глоссарий",
      glossaryBody: "Ищите ключевые юридические термины и изучайте их значение через краткие профессиональные объяснения.",
      glossarySearchPlaceholder: "Поиск юридических терминов...",
      glossaryNoResults: "Юридические термины не найдены.",
