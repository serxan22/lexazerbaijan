...
export function AuthorCard({
  ...
  return (
    <Card className="h-full border-border/80 bg-card/90 transition hover:-translate-y-1 hover:border-gold/35 hover:shadow-soft">
      <CardContent className="p-6">
        ...
        <div className="mt-6 grid grid-cols-3 gap-2 border-t border-border/80 pt-4 text-xs text-slate-500 dark:text-slate-400">
