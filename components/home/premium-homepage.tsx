        ...
        <div className="legal-container relative z-10 grid min-h-[82svh] gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="max-w-4xl">
            ...
            >
              <Link
                href="/articles"
                className="inline-flex h-12 items-center justify-center gap-2 rounded-lg bg-[#111827] px-5 text-sm font-semibold text-white shadow-[0_18px_42px_rgba(17,24,39,0.22)] hover:bg-[#243044] dark:bg-[#f3d28d] dark:text-[#071a33] dark:hover:bg-[#ffe2a4]"
              >
