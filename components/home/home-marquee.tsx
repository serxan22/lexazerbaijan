...
export function HomeMarquee({ phrases }: HomeMarqueeProps) {
  ...
  return (
    <HomeReveal y={16} mobileY={10} scale={0.995} mobileScale={1} blur={0} mobileBlur={0} amount={0.35} hiddenOpacity={0.92} mobileHiddenOpacity={0.95}>
      <div data-story="marquee" className="relative overflow-hidden border-y border-[#d9c79f]/60 bg-[#fffaf0]/70 py-4 text-[#1b2230] shadow-[0_16px_60px_rgba(15,23,42,0.05)] backdrop-blur dark:border-[#b8894a]/20 dark:bg-[#07111f]/75 dark:text-[#f8fafc]">
